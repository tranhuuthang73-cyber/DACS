"""
Sweep for F-dataset - Drug-Disease Association Prediction

Usage:
  python sweep_f.py                       # Run with winning config, max 3 loops
  python sweep_f.py --max_sweep_loops 1   # Run once only
...
def main():
    parser = argparse.ArgumentParser(description="Auto sweep for F-dataset")
    ...
    v1_dir = repo_root / "Result" / "F-dataset" / "AMNTDDA_improved" / "V1"
    ...
    print(f"Dataset: F-dataset | Epochs: {args.epochs} | K-fold: {args.k_fold}")
