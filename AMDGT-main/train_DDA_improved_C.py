...
Usage:
  python train_DDA_improved.py --dataset C-dataset --version v1
...
from model.AMNTDDA_improved_C import AMNTDDA_improved_C
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pos_weight', type=float, default=1.0, help='Positive class weight to boost Recall (C-dataset specific)')
    ...
    if args.loss_type == "focal":
        ...
        # C-dataset specific: Weighted Cross Entropy to boost recall
