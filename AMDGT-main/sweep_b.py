"""
Sweep for B-dataset - Drug-Disease Association Prediction

Usage:
  python sweep_b.py                       # Run with winning config, max 3 loops
  python sweep_b.py --max_sweep_loops 1   # Run once only
...
def main():
    parser = argparse.ArgumentParser(description="Auto sweep for B-dataset")
    ...
    print(f"Dataset: B-dataset | Epochs: {args.epochs} | K-fold: {args.k_fold}")
